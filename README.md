...
*   **Base URL Guidance + Demo Links:**
    ...
    - **Windows Desktop (Phase 8):** 📋 `http://localhost:<backend-port>` (current default for desktop runtime)
*   **Quick Verification:**
...
*   **Windows Docs:**
    - Live setup guide: [`WINDOWS_LIVE_SETUP.md`](./WINDOWS_LIVE_SETUP.md)
    - Release checklist: [`WINDOWS_RELEASE_CHECKLIST.md`](./WINDOWS_RELEASE_CHECKLIST.md)
