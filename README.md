...
> *Turn product context and objectives into INVEST-ready, JIRA-syncable stories with AI + market research.*
...
*   **Backend:** Python 3.11+, FastAPI, OpenAI API, SerpAPI, JIRA REST
*   **Frontend:** Kotlin Multiplatform (Android, iOS, Desktop)
